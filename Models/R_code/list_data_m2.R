...
ED_pred<-array(NA,dim=c(N_sites_pred,N_education_levels-1,N_scenarios))
ED_pred[,,1]<-as.matrix(cbind(d_pred$ED1_past,d_pred$ED2_past,d_pred$ED3_past,d_pred$ED4_past,d_pred$ED5_past,d_pred$ED6_past))
ED_pred[,,2]<-as.matrix(cbind(d_pred$ED1_recent,d_pred$ED2_recent,d_pred$ED3_recent,d_pred$ED4_recent,d_pred$ED5_recent,d_pred$ED6_recent))
ED_pred[,,3]<-as.matrix(cbind(d_pred$ED1_present,d_pred$ED2_present,d_pred$ED3_present,d_pred$ED4_present,d_pred$ED5_present,d_pred$ED6_present))
